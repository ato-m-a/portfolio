    ...
    <Wrapper>
      <div className="container mx-auto flex justify-between">
        <div className="flex-1">
          <h1 className="text-5xl text-primary font-normal py-1 max-lg:text-3xl max-md:text-2xl">
            홍준혁
          </h1>
          <h2 className="text-2xl font-thin text-primary max-lg:text-xl max-md:text-lg">
            몰입해서 더 즐거운 개발자
          </h2>
        </div>
