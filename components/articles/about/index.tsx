    ...
    <div className="flex max-md:block justify-between items-center">
      ...
      <article className="flex flex-col gap-2 text-lg w-3/5 max-md:w-full font-extralight leading-9 max-md:mx-auto break-all">
        <p>
          ...
          개발/배포/운영을 해왔습니다. 이 과정에서, 비즈니스 도메인에 맞닿은 영역에서의
          <TextHighlight>데이터 흐름 처리</TextHighlight>, 렌더링 전략 구성 등의{' '}
          <TextHighlight>시스템 설계</TextHighlight> 경험을 쌓아왔습니다.
        </p>
        <p>
          ...
          고객이 서비스를 원활하게 이용할 수 있도록{' '}
          <TextHighlight>프론트엔드 성능 개선</TextHighlight>에 집중하고 있습니다.
        </p>
        <p>
          더 나아가, 동료를 첫 번째 고객으로 생각하며 조직 차원의{' '}
          <TextHighlight>개발 생산성을 향상</TextHighlight>시키는 일에 보람을 느낍니다. 표준을
          정의하기 위한 FSD 등의 구조적 컨벤션 도입, 중복 코드 제거 및 공통 모듈 개발, 새로운 기술의
          연구/적용 등 다양한 방법으로 업무 효율을 제고하는 일을 좋아합니다.
        </p>
      </article>
    </div>
  );
