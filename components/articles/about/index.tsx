  ...
  return (
    <div className="flex max-md:block justify-between items-center">
      ...
      <article className="flex flex-col gap-2 text-lg w-3/5 max-md:w-full font-extralight leading-9 max-md:mx-auto break-all">
        ...
        <p>
          더 나아가, 동료를 첫 번째 고객으로 생각하며 조직 차원의 <TextHighlight>개발 생산성을 향상</TextHighlight>시키는 일에 보람을 느낍니다. 표준을 정의하기 위한 FSD 등의 구조적 컨벤션 도입,
          반복되는 패턴을 식별해 중복 작성되는 코드를 제거하고 공통 모듈로 관리하는 등 점진적으로 코드 베이스를 개선하는 과정을 즐깁니다.
        </p>
      </article>
    </div>
  )
