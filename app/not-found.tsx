  ...
  return (
    <Figure>
      ...
      <figcaption className="pt-10 flex flex-col justify-center items-center">
        <h1 className={`${dejavuSansMono.className} font-semibold text-9xl text-blue-500 py-4`}>
          404
        </h1>
        ...
        <Link
          href="/"
          className="hv-btn rounded-lg shadow-lg mt-6 px-8 py-3 bg-blue-500 text-white text-xl cursor-pointer transition-opacity ease-in-out"
        >
          돌아가기
        </Link>
      </figcaption>
